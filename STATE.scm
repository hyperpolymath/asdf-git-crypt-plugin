...
;; STATE.scm - Project state tracking for asdf-git-crypt-plugin
;; Media-Type: application/vnd.state+scm

(define-state asdf-git-crypt-plugin
  (metadata
    (version "0.1.0")
    (schema-version "1.0.0")
    (created "2026-01-30")
    (updated "2026-01-30")
    (project "asdf-git-crypt-plugin")
    (repo "hyperpolymath/asdf-git-crypt-plugin"))

  (project-context
    (name "asdf-git-crypt-plugin")
