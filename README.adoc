...
:url-repo: https://github.com/hyperpolymath/asdf-git-crypt-plugin
...
image:https://img.shields.io/github/license/hyperpolymath/asdf-git-crypt-plugin?style=flat-square[License,link=LICENSE]
image:https://img.shields.io/github/v/release/hyperpolymath/asdf-git-crypt-plugin?style=flat-square[Release,link={url-repo}/releases]
image:https://img.shields.io/github/actions/workflow/status/hyperpolymath/asdf-git-crypt-plugin/ci.yml?branch=main&style=flat-square[Build Status,link={url-repo}/actions]
image:https://img.shields.io/badge/asdf-plugin-blue?style=flat-square[asdf Plugin,link={url-asdf}]

[.lead]
An {url-asdf}[asdf] plugin to install and manage {url-tool}[Git Crypt] versions.
...
Git Crypt is an upstream tool managed by this plugin. Refer to the official
...
|**Version Switching**
|Switch between Git Crypt versions per project

|**Project Isolation**
|Pin Git Crypt per repository via `.tool-versions`

|**Reproducible Builds**
|Align CI/CD and developer environments to the same Git Crypt version
...
=== Installing Git Crypt Versions

[source,bash]
----
asdf list all git-crypt
asdf install git-crypt latest
asdf install git-crypt 0.1.0
----
...
[source,bash]
----
asdf global git-crypt 0.1.0
asdf local git-crypt 0.1.0
asdf current git-crypt
git-crypt --version
----
...
* Ensure `git-crypt` is on PATH after installation.
* Verify the installed version with `git-crypt --version`.
